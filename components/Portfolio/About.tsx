...
export const About = () => {
  ...
  return (
    <>
    <h1 className="text-4xl md:text-5xl font-bold mb-3 sm:text-center md:my-5 mx-5">How can I help?</h1>
    <div className="flex lg:flex-row flex-col items-start lg:items-center justify-center p-3 pb-0 lg:p-12">
          ...
          return (
            ...
            >
              ...
              <div className="text-muted-foreground">
                ...
                <p className="hidden lg:block">{data[item].projectsCompleted} Projects Completed</p>
              </div>
            </div>
          );
        })}
      ...
      <div className="md:mx-4 p-4 lg:w-[40vw] my-2">
        ...
        <div className="border rounded-md w-fit p-2 bg-primary-foreground">
          <p className="text-4xl md:text-5xl text-muted-foreground">{data[tab].linesOfCode}+</p>
